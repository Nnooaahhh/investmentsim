...
avatars = [
    pygame.image.load("https://www.nicepng.com/png/detail/348-3483446_2d-character-design-wassermolekl.png"),  # Replace with your image file paths
    pygame.image.load("https://opengameart.org/sites/default/files/player_19.png"),
    pygame.image.load("https://www.pngitem.com/pimgs/m/190-1906083_2d-girl-character-png-transparent-png.png"),
]
